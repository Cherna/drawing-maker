...
export const TOOL_DEFINITIONS: Record<string, ToolDefinition> = {
  ...
  'image-hatching': {
    ...
    params: [
      ...
      { key: 'preFilter', label: 'Pre-filter Image', type: 'boolean', default: false },
      { key: 'preBrightness', label: 'Brightness', type: 'number', min: 0, max: 2, step: 0.05, default: 1, showIf: (p) => p.preFilter },
      { key: 'preContrast', label: 'Contrast', type: 'number', min: -1, max: 1, step: 0.05, default: 0, showIf: (p) => p.preFilter },
      { key: 'shadingSteps', label: 'Shading Steps', type: 'number', min: 1, max: 50, step: 1, default: 5 },
      { key: 'density', label: 'Density Multiplier', type: 'number', min: 0.1, max: 30, step: 0.1, default: 1.5 },
      ...
      { key: 'contourThreshold', label: 'Contour Position', type: 'number', min: 0, max: 1, step: 0.05, default: 0.5 },
      { key: 'drawContour', label: 'Draw Contour', type: 'boolean', default: false },
      { key: 'contourBrightnessThreshold', label: 'Contour Brightness Limit', type: 'number', min: 0, max: 1, step: 0.05, default: 1.0, showIf: (p) => p.drawContour },
      { key: 'blur', label: 'Blur (Fuzziness)', type: 'number', min: 0, max: 20, step: 0.5, default: 0 },
      { key: 'minAlpha', label: 'Min Alpha', type: 'number', min: 0, max: 1, step: 0.05, default: 0.5 },
      { key: 'maxAlpha', label: 'Max Alpha', type: 'number', min: 0, max: 1, step: 0.05, default: 1.0 },
    ],
  },
  'image-normal-tracing': {
    category: 'generator',
    label: 'Image Normal Tracing',
    params: [
      { key: 'densityMap', label: 'Density Map (Mask)', type: 'image' },
      { key: 'normalMap', label: 'Normal Map', type: 'image' },
      { key: 'preFilter', label: 'Pre-filter Image', type: 'boolean', default: false },
      { key: 'preBrightness', label: 'Brightness', type: 'number', min: 0, max: 2, step: 0.05, default: 1, showIf: (p) => p.preFilter },
      { key: 'preContrast', label: 'Contrast', type: 'number', min: -1, max: 1, step: 0.05, default: 0, showIf: (p) => p.preFilter },
      { key: 'shadingSteps', label: 'Shading Steps', type: 'number', min: 1, max: 50, step: 1, default: 5 },
      { key: 'density', label: 'Density Multiplier', type: 'number', min: 0.1, max: 30, step: 0.1, default: 1.5 },
      { key: 'baseAngle', label: 'Fallback Angle', type: 'number', min: 0, max: 360, step: 1, default: 45 },
      { key: 'threshold', label: 'Ignore Brightness >', type: 'number', min: 0, max: 1, step: 0.05, default: 0.95 },
      { key: 'scale', label: 'Scale', type: 'number', min: 0.1, max: 10, step: 0.1, default: 1 },
      { key: 'offsetX', label: 'Offset X (%)', type: 'number', min: -100, max: 100, step: 1, default: 0 },
      { key: 'offsetY', label: 'Offset Y (%)', type: 'number', min: -100, max: 100, step: 1, default: 0 },
  ...
  'concentric-hatching': {
    category: 'generator',
    label: 'Concentric Hatching',
    params: [
      { key: 'densityMap', label: 'Density Map', type: 'image' },
      { key: 'preFilter', label: 'Pre-filter Image', type: 'boolean', default: false },
      { key: 'preBrightness', label: 'Brightness', type: 'number', min: 0, max: 2, step: 0.05, default: 1, showIf: (p) => p.preFilter },
      { key: 'preContrast', label: 'Contrast', type: 'number', min: -1, max: 1, step: 0.05, default: 0, showIf: (p) => p.preFilter },
      ...
      { key: 'minAlpha', label: 'Min Alpha', type: 'number', min: 0, max: 1, step: 0.05, default: 0.5 },
      { key: 'maxAlpha', label: 'Max Alpha', type: 'number', min: 0, max: 1, step: 0.05, default: 1.0 },
      { key: 'showShading', label: 'Show Shading', type: 'boolean', default: false },
      { key: 'contourThreshold', label: 'Contour Position', type: 'number', min: 0, max: 1, step: 0.05, default: 0.5 },
      { key: 'drawContour', label: 'Draw Contour', type: 'boolean', default: false },
      { key: 'contourBrightnessThreshold', label: 'Contour Brightness Limit', type: 'number', min: 0, max: 1, step: 0.05, default: 1.0, showIf: (p) => p.drawContour },
      { key: 'simplifyContour', label: 'Simplify Contour', type: 'boolean', default: false, showIf: (p) => p.drawContour },
      { key: 'simplifyTolerance', label: 'Simplify Tolerance (mm)', type: 'number', min: 0.01, max: 10, step: 0.01, default: 0.3, showIf: (p) => p.drawContour && p.simplifyContour },
